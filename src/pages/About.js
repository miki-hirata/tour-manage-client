          ...
          <CardInner>
            ...
            <div>
              ...
              <p>{/* ツアーマネージャーの業務で一番手間がかかるのが、出発直前にツアーのスケジュールを全て入力し、印刷・製本する「ロードスケジュール」作成業務でした。 */}
                <br/>Tour m. は{/* そんな「ロードスケジュール」の代わりとして、 */}ツアーメンバー全員がスケジュールを共有するためのアプリです。
                ツアーマネージャーは準備段階で決まったことを順番に入力していくだけなので、出発直前の作成業務は発生せず、ツアー中に変更があった場合も簡単な口頭連絡だけで済みます。忙しいツアー中の使用を想定しているので、レイアウトはスマートフォンをベースに作成しています。
